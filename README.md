# Ultima Orb (Obsidian Plugin)

ปลั๊กอิน Obsidian สำหรับโมดูล AI แบบประกอบได้
โฟกัส: Tools, Agents แบบเบาๆ และ UI ที่ไม่รบกวนการเขียน

## สถานะ
- Core load/enable/disable: ✔︎
- Basic command: ✔︎
- Settings tab: ⧗
- Integrations (Notion, ChatGPT, ฯลฯ): แผนงาน
